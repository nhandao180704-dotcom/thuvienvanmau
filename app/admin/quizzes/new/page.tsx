...
export default function CreateQuizPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {/* ĐÃ BỌC SUSPENSE Ở ĐÂY ĐỂ FIX LỖI NEXT.JS */}
      <Suspense fallback={<div className="p-8 text-center text-slate-500 font-medium">Đang tải dữ liệu...</div>}>
